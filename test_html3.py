...
def test_server_home(start_server):
    ...
    response = urllib2.urlopen('http://127.0.0.1:10000/')
...
def test_server_html(start_server):
    ...
    response = urllib2.urlopen('http://127.0.0.1:10000/a_web_page.html').read()
...
def test_server_txt(start_server):
    ...
    response = urllib2.urlopen('http://127.0.0.1:10000/sample.txt').read()
...
def test_server_file(start_server):
    ...
    response = urllib2.urlopen('http://127.0.0.1:10000/images/JPEG_example.jpg').read()
...
def test_server_error_server_404():
    ...
    with pytest.raises(urllib2.HTTPError) as error:
        urllib2.urlopen('http://127.0.0.1:10000/images/JPEG_example2.jpg')
